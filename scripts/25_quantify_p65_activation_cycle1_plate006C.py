...
layout_file = DATA_ROOT / '49 Cystic Fibrosis - Rabin' / 'Data' / '24 well plate 006C' / 'Plate006C_layout.xlsx'

# Path to PKL files directory
pkl_path = DATA_ROOT / '49 Cystic Fibrosis - Rabin' / 'Data' / '24 well plate 006C' / '29Dec2025 cycle 1 IF' / '09 PKL single cell'

# Output directory for plots
plot_output_dir = FIGURES_ROOT / '006C_fibroblast_only_coculture'
